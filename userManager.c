...
{
        userManagerSetCurrentUserFromFile("user.txt", username);
}
...
{
        return saveUserToFile("user.txt", username, password);
}
...
{
        return validateUserInFile("user.txt", username, password, 1);
}
